...
North Carolina flavor for Victoria 3 (`1.13.*`): journal chains, decisions, unique buildings, companies, characters, and state traits — without a full USA overhaul.
...
**Current release:** 1.3.0 · **Game version:** `1.13.*` · See [CHANGELOG.md](CHANGELOG.md) for details.

## Install

1. Place this folder in your Victoria 3 `mod/` directory, or subscribe via Paradox Mods / Steam Workshop.
2. Enable **North Carolina Flavor Pack** in the launcher.
3. Play as the USA (or any country that owns incorporated North Carolina) for the full journal tab.

Compatible with vanilla USA; no hard dependencies on other flavor mods. Company **prestige goods** require the Charters of Commerce DLC.
...
After script changes, sanity-check in-game:
